  ...
  if (k==2)
    {
      ...
      for (int i=1; i < 9; i++)
      {
        for (int j=1; j < 13; j++)
        {
          Int_t nodeID = 96 + (i-1)*12+j;
          if (i==1)
          {
          TGeoVolume *segmentvolume11 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment1, pMedBMDFscScint);
          replica2->AddNode(segmentvolume11, nodeID, new TGeoCombiTrans (121.72/10 * TMath::Cos(0.523599*(j-1)), 121.72/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          ...
          replica2->AddNode(segmentvolume12, nodeID, new TGeoCombiTrans (169.03705/10 * TMath::Cos(0.523599*(j-1)), 169.03705/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          ...
          replica2->AddNode(segmentvolume13, nodeID, new TGeoCombiTrans (217.33335/10 * TMath::Cos(0.523599*(j-1)), 217.33335/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          replica2->SetLineColor(kGreen);
          }
          if (i==4)
          {
          TGeoVolume *segmentvolume14 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment4, pMedBMDFscScint);
          replica2->AddNode(segmentvolume14, nodeID, new TGeoCombiTrans (265.6296/10 * TMath::Cos(0.523599*(j-1)), 265.6296/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          replica2->SetLineColor(kYellow);
          }
          if (i==5)
          {
          TGeoVolume *segmentvolume15 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment5, pMedBMDFscScint);
          replica2->AddNode(segmentvolume15, nodeID, new TGeoCombiTrans (313.9259/10 * TMath::Cos(0.523599*(j-1)), 313.9259/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          replica2->SetLineColor(kGreen);
          }
          if (i==6)
          {
          TGeoVolume *segmentvolume16 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment6, pMedBMDFscScint);
          replica2->AddNode(segmentvolume16, nodeID, new TGeoCombiTrans (362.22215/10 * TMath::Cos(0.523599*(j-1)), 362.22215/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          replica2->SetLineColor(kYellow);
          }
          if (i==7)
          {
          TGeoVolume *segmentvolume17 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment7, pMedBMDFscScint);
          replica2->AddNode(segmentvolume17, nodeID, new TGeoCombiTrans (410.51845/10 * TMath::Cos(0.523599*(j-1)), 410.51845/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          replica2->SetLineColor(kGreen);
          }
          if (i==8)
          {
          TGeoVolume *segmentvolume18 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment8, pMedBMDFscScint);
          replica2->AddNode(segmentvolume18, nodeID, new TGeoCombiTrans (459.5392/10 * TMath::Cos(0.523599*(j-1)), 459.5392/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          replica2->SetLineColor(kGreen);
          }
        }
      }
    ...
    if (k==1)
    {
      ...
      for (int i=1; i < 9; i++)
      {
        for (int j=1; j < 13; j++)
        {
          Int_t nodeID = (i-1)*12+j;
          if (i==1)
          {
            TGeoVolume *segmentvolume21 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment1, pMedBMDFscScint);
            replica1->AddNode(segmentvolume21, nodeID, new TGeoCombiTrans (121.72/10 * TMath::Cos(0.523599*(j-1)), 121.72/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
          if (i==2)
          {
            TGeoVolume *segmentvolume22 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment2, pMedBMDFscScint);
            replica1->AddNode(segmentvolume22, nodeID, new TGeoCombiTrans (169.03705/10 * TMath::Cos(0.523599*(j-1)), 169.03705/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
          if (i==3)
          {
            TGeoVolume *segmentvolume23 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment3, pMedBMDFscScint);
            replica1->AddNode(segmentvolume23, nodeID, new TGeoCombiTrans (217.33335/10 * TMath::Cos(0.523599*(j-1)), 217.33335/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
          if (i==4)
          {
            TGeoVolume *segmentvolume24 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment4, pMedBMDFscScint);
            replica1->AddNode(segmentvolume24, nodeID, new TGeoCombiTrans (265.6296/10 * TMath::Cos(0.523599*(j-1)), 265.6296/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
          if (i==5)
          {
            TGeoVolume *segmentvolume25 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment5, pMedBMDFscScint);
            replica1->AddNode(segmentvolume25, nodeID, new TGeoCombiTrans (313.9259/10 * TMath::Cos(0.523599*(j-1)), 313.9259/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
          if (i==6)
          {
            TGeoVolume *segmentvolume26 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment6, pMedBMDFscScint);
            replica1->AddNode(segmentvolume26, nodeID, new TGeoCombiTrans (362.22215/10 * TMath::Cos(0.523599*(j-1)), 362.22215/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
          if (i==7)
          {
            TGeoVolume *segmentvolume27 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment7, pMedBMDFscScint);
            replica1->AddNode(segmentvolume27, nodeID, new TGeoCombiTrans (410.51845/10 * TMath::Cos(0.523599*(j-1)), 410.51845/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
          if (i==8)
          {
            TGeoVolume *segmentvolume28 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment8, pMedBMDFscScint);
            replica1->AddNode(segmentvolume28, nodeID, new TGeoCombiTrans (459.5392/10 * TMath::Cos(0.523599*(j-1)), 459.5392/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
        }
      }
    }
