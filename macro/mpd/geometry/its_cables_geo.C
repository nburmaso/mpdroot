...
void its_cables_geo()
{
  ...
  // output file
  const char* filename = "its_cables.geo";
  ...
  for (Int_t j = 0; j < Nsensor - 1; j++) {   // 4 
    ...
    xWidth = 0.5*sensor_h; // always 31mm
    yWidth = 0.5*cableThick; // always 0.058 mm
 
    // Start with "right" side
    zWidth = (crz[4]-crz[j])/2.;
    ...
    cout <<cablename.str() << endl;
    cout << clz[j] << endl;
    cable = new Mpdshape(f, cablename.str(), "sts01ladder1", 
			 "BOX", "silicon_dead", points.str(), position.str());
    cable->SetSegment(1);
    cable->SetMotherSegment(1);
  ...
  for (Int_t j = 0; j < Nsensor - 1; j++) {   // 4 
    ...
    //	cout <<cablename.str() << endl;
    //	cout << clz[j] << endl;
    cable = new Mpdshape(f, cablename.str(), "sts01ladder2", 
			 "BOX", "silicon_dead", points.str(), position.str());
    cable->SetSegment(1);
    cable->SetMotherSegment(1);
  ...
  for (Int_t j = 0; j < Nsensor - 1; j++) {   // 4 
    ...
    cout <<cablename.str() << endl;
    cout << clz[j] << endl;
    cable = new Mpdshape(f, cablename.str(), "sts01ladder3", 
			 "BOX", "silicon_dead", points.str(), position.str());
    cable->SetSegment(1);
    cable->SetMotherSegment(1);
  ...
  for (Int_t j = 0; j < Nsensor - 1; j++) {   // 4 
    ...
    cout <<cablename.str() << endl;
    cout << clz[j] << endl;
    cable = new Mpdshape(f, cablename.str(), "sts01ladder4", 
			 "BOX", "silicon_dead", points.str(), position.str());
    cable->SetSegment(1);
    cable->SetMotherSegment(1);
