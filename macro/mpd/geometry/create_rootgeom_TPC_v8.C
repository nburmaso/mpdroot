...
void CreateThermoscreenRadial(TGeoVolume *mother_volume)
{
    ...
    TGeoTubeSeg * CoolingPlateS = new TGeoTubeSeg(plate_name, Thermoscreen_Rad_R - Thermoscreen_Thick / 2, Thermoscreen_Rad_R + Thermoscreen_Thick / 2, Thermoscreen_Rad_Length / 2, -Thermoscreen_Rad_Panel_Angle / 2, Thermoscreen_Rad_Panel_Angle / 2);
    ...
    Double_t xl = (Thermoscreen_Rad_R + Thermoscreen_Thick / 2) * TMath::Cos(Thermoscreen_Rad_Seg_Angle / 2 * TMath::DegToRad()) + Thermoscreen_Rad_R_shift;
    Double_t yl = (Thermoscreen_Rad_R + Thermoscreen_Thick / 2) * TMath::Sin(Thermoscreen_Rad_Seg_Angle / 2 * TMath::DegToRad());
    ...
    Double_t angle = TMath::ATan((y1[3] - y1[2]) / Thermoscreen_Rad_Hold1_Height) + TMath::PiOver2();;
    ...
    TGeoCombiTrans * pos = new TGeoCombiTrans();
    pos->SetTranslation(R - (Thermoscreen_Rad_R - Thermoscreen_Rad_R*TMath::Cos(TMath::Pi() - 7 * Thermoscreen_Rad_Seg_Angle * TMath::DegToRad())), Thermoscreen_Rad_Hold1_GapBetween / 2, 0.);
    TGeoCombiTrans * posreflY = new TGeoCombiTrans(*pos);
    posreflY->ReflectY(true);
    TGeoCombiTrans * posreflX = new TGeoCombiTrans(*pos);
    posreflX->ReflectX(true);
