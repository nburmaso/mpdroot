...
const Double_t WALL_Zpos = 319.48;//cm to WALL surface
const Double_t WALL_center_Zpos = 319.49;//3.2 m (319.5-0.01);//cm
...
Double_t Wall_inner_radius = 0.; 
Double_t Wall_outer_radius = 300.; 
Double_t Wall_Z_size = 0.01; //0.02/2.
...
void create_rootgeom_wall_vacuum_no_hole_oldnames_v1() {
    ...
    const TString geoDetectorName = "wall_vacuum_no_hole_oldnames";
