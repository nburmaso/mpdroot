...
void building(TGeoVolume *mother_volume, Int_t A_or_B_side, Int_t nring);
...
void cpcgeom3()
{
  ...
  TGeoTranslation *tr1 = new TGeoTranslation("tr1", 0., 0., 0.);
  tr1->RegisterYourself();
  TGeoTranslation *tr2 = new TGeoTranslation("tr2", 0., 0, 0.);
  tr2->RegisterYourself();
  TGeoTranslation *tr3 = new TGeoTranslation("tr3", 0., 0., 0.);
  tr3->RegisterYourself();
  TGeoTranslation *tr4 = new TGeoTranslation("tr4", 0., 0., 0.);
  tr4->RegisterYourself();
  TGeoTranslation *tr5 = new TGeoTranslation("tr5", 0., 0., 0.);
  tr5->RegisterYourself();
  TGeoTranslation *tr6 = new TGeoTranslation("tr6", 0., 0., 0.);
  tr6->RegisterYourself();
  TGeoTranslation *tr7 = new TGeoTranslation("tr7", 0., 0., 0.);
  tr7->RegisterYourself();
  TGeoTranslation *tr8 = new TGeoTranslation("tr8", 0., 0., 0.);
  tr8->RegisterYourself();
  TGeoTranslation *cr11 = new TGeoTranslation("cr11", 0., 8.6286/10, 0.);
  cr11->RegisterYourself();
  TGeoTranslation *cr12 = new TGeoTranslation("cr12", 0., -8.6286/10, 0.);
  cr12->RegisterYourself();
  TGeoTranslation *cr21 = new TGeoTranslation("cr21", 0., 20.2933/10, 0.);
  cr21->RegisterYourself();
  TGeoTranslation *cr22 = new TGeoTranslation("cr22", 0., -20.2933/10, 0.);
  cr22->RegisterYourself();
  TGeoTranslation *cr31 = new TGeoTranslation("cr31", 0., 33.2343/10, 0.);
  cr31->RegisterYourself();
  TGeoTranslation *cr32 = new TGeoTranslation("cr32", 0.,-33.2343/10, 0.);
  cr32->RegisterYourself();
  TGeoTranslation *cr41 = new TGeoTranslation("cr41", 0., 46.1752/10, 0.);
  cr41->RegisterYourself();
  TGeoTranslation *cr42 = new TGeoTranslation("cr42", 0., -46.1752/10, 0.);
  cr42->RegisterYourself();
  TGeoTranslation *cr51 = new TGeoTranslation("cr51", 0., 59.1162/10, 0.);
  cr51->RegisterYourself();
  TGeoTranslation *cr52 = new TGeoTranslation("cr52", 0., -59.1162/10, 0.);
  cr52->RegisterYourself();
  TGeoTranslation *cr61 = new TGeoTranslation("cr61", 0., 72.0571/10, 0.);
  cr61->RegisterYourself();
  TGeoTranslation *cr62 = new TGeoTranslation("cr62", 0., -72.0571/10, 0.);
  cr62->RegisterYourself();
  TGeoTranslation *cr71 = new TGeoTranslation("cr71", 0., 84.9981/10, 0.);
  cr71->RegisterYourself();
  TGeoTranslation *cr72 = new TGeoTranslation("cr72", 0., -84.9981/10, 0.);
  cr72->RegisterYourself();
  TGeoTranslation *cr81 = new TGeoTranslation("cr81", 0., 97.3832/10, 0.);
  cr81->RegisterYourself();
  TGeoTranslation *cr82 = new TGeoTranslation("cr82", 0., -97.3832/10, 0.);
  ...
  if (k==2)
    {
      ...
      for (int i=1; i < 9; i++)
      {
        for (int j=1; j < 13; j++)
        {
          ...
          replica2->AddNode(segmentvolume11, 96 + i * 12 - (12 - j), new TGeoCombiTrans (121.72/10 * TMath::Cos(0.523599*(j-1)), 121.72/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          ...
          replica2->AddNode(segmentvolume12, 96 + i * 12 - (12 - j), new TGeoCombiTrans (169.03705/10 * TMath::Cos(0.523599*(j-1)), 169.03705/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          ...
          replica2->AddNode(segmentvolume13, 96 + i * 12 - (12 - j), new TGeoCombiTrans (217.33335/10 * TMath::Cos(0.523599*(j-1)), 217.33335/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          replica2->SetLineColor(kGreen);
          }
          if (i==4)
          {
          TGeoVolume *segmentvolume14 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment4, pMedBMDFscScint);
          replica2->AddNode(segmentvolume14, 96 + i * 12 - (12 - j), new TGeoCombiTrans (265.6296/10 * TMath::Cos(0.523599*(j-1)), 265.6296/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          replica2->SetLineColor(kYellow);
          }
          if (i==5)
          {
          TGeoVolume *segmentvolume15 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment5, pMedBMDFscScint);
          replica2->AddNode(segmentvolume15, 96 + i * 12 - (12 - j), new TGeoCombiTrans (313.9259/10 * TMath::Cos(0.523599*(j-1)), 313.9259/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          replica2->SetLineColor(kGreen);
          }
          if (i==6)
          {
          TGeoVolume *segmentvolume16 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment6, pMedBMDFscScint);
          replica2->AddNode(segmentvolume16, 96 + i * 12 - (12 - j), new TGeoCombiTrans (362.22215/10 * TMath::Cos(0.523599*(j-1)), 362.22215/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          replica2->SetLineColor(kYellow);
          }
          if (i==7)
          {
          TGeoVolume *segmentvolume17 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment7, pMedBMDFscScint);
          replica2->AddNode(segmentvolume17, 96 + i * 12 - (12 - j), new TGeoCombiTrans (410.51845/10 * TMath::Cos(0.523599*(j-1)), 410.51845/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          replica2->SetLineColor(kGreen);
          }
          if (i==8)
          {
          TGeoVolume *segmentvolume18 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment8, pMedBMDFscScint);
          replica2->AddNode(segmentvolume18, 96 + i * 12 - (12 - j), new TGeoCombiTrans (459.5392/10 * TMath::Cos(0.523599*(j-1)), 459.5392/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          replica2->SetLineColor(kGreen);
          }
        }
      }
    ...
    if (k==1)
    {
      ...
      for (int i=1; i < 9; i++)
      {
        for (int j=1; j < 13; j++)
        {
          ...
          replica1->AddNode(segmentvolume21, i * 12 - (12 - j), new TGeoCombiTrans (121.72/10 * TMath::Cos(0.523599*(j-1)), 121.72/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
          if (i==2)
          {
          TGeoVolume *segmentvolume22 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment2, pMedBMDFscScint);
          replica1->AddNode(segmentvolume22, i * 12 - (12 - j), new TGeoCombiTrans (169.03705/10 * TMath::Cos(0.523599*(j-1)), 169.03705/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
          if (i==3)
          {
          TGeoVolume *segmentvolume23 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment3, pMedBMDFscScint);
          replica1->AddNode(segmentvolume23, i * 12 - (12 - j), new TGeoCombiTrans (217.33335/10 * TMath::Cos(0.523599*(j-1)), 217.33335/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
          if (i==4)
          {
          TGeoVolume *segmentvolume24 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment4, pMedBMDFscScint);
          replica1->AddNode(segmentvolume24, i * 12 - (12 - j), new TGeoCombiTrans (265.6296/10 * TMath::Cos(0.523599*(j-1)), 265.6296/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
          if (i==5)
          {
          TGeoVolume *segmentvolume25 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment5, pMedBMDFscScint);
          replica1->AddNode(segmentvolume25, i * 12 - (12 - j), new TGeoCombiTrans (313.9259/10 * TMath::Cos(0.523599*(j-1)), 313.9259/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
          if (i==6)
          {
          TGeoVolume *segmentvolume26 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment6, pMedBMDFscScint);
          replica1->AddNode(segmentvolume26, i * 12 - (12 - j), new TGeoCombiTrans (362.22215/10 * TMath::Cos(0.523599*(j-1)), 362.22215/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
          if (i==7)
          {
          TGeoVolume *segmentvolume27 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment7, pMedBMDFscScint);
          replica1->AddNode(segmentvolume27, i * 12 - (12 - j), new TGeoCombiTrans (410.51845/10 * TMath::Cos(0.523599*(j-1)), 410.51845/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
          if (i==8)
          {
          TGeoVolume *segmentvolume28 = new TGeoVolume (Form("segmentvolume_%d_%d_%d", k, i, j), segment8, pMedBMDFscScint);
          replica1->AddNode(segmentvolume28, i * 12 - (12 - j), new TGeoCombiTrans (459.5392/10 * TMath::Cos(0.523599*(j-1)), 459.5392/10 * TMath::Sin(0.523599*(j-1)), 0., new TGeoRotation(Form("rot_%d_%d", i, j), (j-1)*30., 0., 0)));
          }
        }
      }
    }
