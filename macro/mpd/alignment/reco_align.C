...
void reco_align(TString inFile = "$VMCWORKDIR/macro/mpd/evetest.root", TString outFile = "mpddst_align.root", Int_t nStartEvent = 0, Int_t nEvents = 10, TString run_type = "local") {
    // ========================================================================
    ...
    MpdTpcMisalignment * tpcMisalign = new MpdTpcMisalignment();
    tpcMisalign->SetAlignParamsFile("MPDTpcAlignment.xml");
    fRun->AddTask(tpcMisalign);
    
    MpdTpcAlignment * tpcAlign = new MpdTpcAlignment();
    tpcAlign->SetAlignParamsFile("MPDTpcAlignment.xml");
