...
#include "macro/mpd/phase0/geometry_phase0.C"
...
void runMC_phase0(TString inFile = "auau.04gev.0_3fm.10k.f14.gz", TString outFile = "evetest.root", Int_t nStartEvent = 0, Int_t nEvents = 2,
        Bool_t flag_store_FairRadLenPoint = kFALSE, Int_t FieldSwitcher = 0)
{
    ...
    geometry_phase0(fRun,0,0); // load mpd geometry
