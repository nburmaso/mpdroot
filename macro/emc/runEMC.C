...
// LAQGSM file 
//           TString inFile = "auau.04gev.0_3fm.10k.f14.gz", 
           TString outFile = "$VMCWORKDIR/macro/mpd/evetest.root", Int_t 
           nStartEvent = 0, Int_t nEvents = 1000,
...
//    primGen->SmearVertexXY(kTRUE);
    ...
    gRandom->SetSeed(0);
    // ------- Box Generator
//    FairBoxGenerator* boxGen = new FairBoxGenerator(13, 1); // 13 = muon, 1 - multiplicity
    FairBoxGenerator* boxGen = new FairBoxGenerator(111, 1); // 111 = pi0, 1 - multiplicity
//    FairBoxGenerator* boxGen = new FairBoxGenerator(22, 1); // 22 = gamma, 1 - multiplicity
    boxGen->SetPRange(0.2, 0.2); // GeV/c //setPRange vs setPtRange
...
//        fMagField->SetField(0., 0., 5.); // values are in kG:  1T = 10kG
    ...
    // -----------------
    fRun->Run(nEvents);
    fRun->CreateGeometryFile("geometryFile.root");
