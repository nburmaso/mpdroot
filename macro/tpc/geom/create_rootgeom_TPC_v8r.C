/** @file create_rootgeom_TPC_v8r.C
    @author  Alexander Bychkov abychkov@jinr.ru
    @date    August 2020
    @brief   Create root geometry for TPC with place for rail
*/
...
void create_rootgeom_TPC_v8r(ElectronicsGeometryDetailLevel egdl = Low,
