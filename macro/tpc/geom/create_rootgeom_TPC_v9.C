...
void create_rootgeom_TPC_v9(ElectronicsGeometryDetailLevel egdl = Low, Bool_t wrGeoWithMaterials = true)
{
...
void CreateSensitiveVolumes(TGeoVolume *mother_volume, Double_t vol_width)
{
    ...
    TGeoPgon *SensitiveVolumeS = new TGeoPgon(SensitiveVolume_name, 0., 360., 12, 2);
    ...
    mother_volume->AddNode(SensitiveVolumeV, 1, new TGeoTranslation(0., 0., -space_width / 2));
}
