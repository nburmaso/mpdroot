...
class MpdFemtoModelManager {
 ...
 public:
  ...
  void setFreezeOutGenerator(MpdFemtoBaseModelFreezeOutGenerator *foGen) { mFreezeOutGenerator = foGen; }
  /// Set pointer to the freeze-out coordinate generator
  void SetFreezeOutGenerator(MpdFemtoBaseModelFreezeOutGenerator *foGen) { setFreezeOutGenerator(foGen); }
  /// Set pointer to the femtoscopic weight generator
  void setWeightGenerator(MpdFemtoBaseModelWeightGenerator *weightGen)   { mWeightGenerator = weightGen; }
  /// Set pointer to the femtoscopic weight generator
  void SetWeightGenerator(MpdFemtoBaseModelWeightGenerator *weightGen)   { setWeightGenerator(weightGen); }
  ...
  MpdFemtoBaseModelFreezeOutGenerator* freezeOutGenerator() { return mFreezeOutGenerator; }
  /// Return pointer to the freeze-out coordinate generator
  MpdFemtoBaseModelFreezeOutGenerator* FreezeOutGenerator() { return freezeOutGenerator(); }
  /// Return pointer to the pair-weight generator
  MpdFemtoBaseModelWeightGenerator* weightGenerator()       { return mWeightGenerator; }
  /// Return pointer to the pair-weight generator
  MpdFemtoBaseModelWeightGenerator* WeightGenerator()       { return weightGenerator(); }
  /// Return femtoscopic weight
  virtual double weight(MpdFemtoPair *aPair);
  /// Return femtoscopic weight
  virtual double Weight(MpdFemtoPair *aPair)  { return weight(aPair); }
