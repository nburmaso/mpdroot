...
class MpdFemtoBPLCMS3DCorrFctnKt : public MpdFemtoBaseCorrFctn {
 ...
 public:
  ...
  /// Event begin
  virtual void eventBegin(const MpdFemtoEvent* /* event*/ )  { /* empty */ }
  /// Event end
  virtual void eventEnd(const MpdFemtoEvent* /* event*/ )    { /* empty */ }
  /// Finish
  virtual void finish();
  ...
  virtual MpdFemtoBaseCorrFctn* clone() const { return new MpdFemtoBPLCMS3DCorrFctnKt(*this); }
