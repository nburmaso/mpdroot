...
class MpdFemtoEvent {
 ...
 public:
  ...
  MpdFemtoTrackCollection *trackCollection() const { return mTrackCollection; }
  /// Return track collection associated with the current event
  MpdFemtoTrackCollection *TrackCollection() const { return trackCollection(); }
  /// Return v0 collection associated with the current event
  MpdFemtoV0Collection *v0Collection() const { return mV0Collection; }
  /// Return v0 collection associated with the current event
  MpdFemtoV0Collection *V0Collection() const { return v0Collection(); }
  /// Return xi collection associated with the current event
  MpdFemtoXiCollection *xiCollection() const { return mXiCollection; }
  /// Return xi collection associated with the current event
  MpdFemtoXiCollection *XiCollection() const { return xiCollection(); }
  /// Return kink collection associated with the current event
  MpdFemtoKinkCollection *kinkCollection() const { return mKinkCollection; }
  /// Return kink collection associated with the current event
  MpdFemtoKinkCollection *KinkCollection() const { return kinkCollection(); }
