...
#ifdef __ROOT__
ClassImpT(MpdFemtoPhysicalHelix)
#endif
...
//_________________
MpdFemtoPhysicalHelix::MpdFemtoPhysicalHelix(double c, double d, double phase, const TVector3& o, int h) : 
      MpdFemtoHelix(c, d, phase, o, h) {
  /* no-op */
}
