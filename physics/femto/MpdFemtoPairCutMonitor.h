...
//_________________
class MpdFemtoPairCutMonitor : public MpdFemtoBaseCutMonitor {

 public:
  /// Constructor
  MpdFemtoPairCutMonitor(const char*);
  /// Copy constructor
  MpdFemtoPairCutMonitor(const MpdFemtoPairCutMonitor& cutMoni);
  /// Assignment operator
  MpdFemtoPairCutMonitor operator=(const MpdFemtoPairCutMonitor& c);
  /// Destructor
  virtual ~MpdFemtoPairCutMonitor();
...
#ifdef __ROOT__
 ClassDef(MpdFemtoPairCutMonitor, 3)
#endif
};

#endif // #define MpdFemtoPairCutMonitor_h
