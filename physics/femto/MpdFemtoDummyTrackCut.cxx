///
/// \file MpdFemtoDummyTrackCut.cxx
///
...
bool MpdFemtoDummyTrackCut::pass(const MpdFemtoTrack* track) {
...
MpdFemtoString MpdFemtoDummyTrackCut::report() {
    // construct report
    TString report;
...
TList *MpdFemtoDummyTrackCut::listSettings() {
    // return a list of settings in a writable form
    TList *settings_list = new TList();

    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.mass=%f", mass())
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.charge=%i", fCharge)
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.nsigmapion.minimum=%f", fNSigmaPion[0])
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.nsigmapion.maximum=%f", fNSigmaPion[1])
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.nsigmakaon.minimum=%f", fNSigmaKaon[0])
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.nsigmakaon.maximum=%f", fNSigmaKaon[1])
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.nsigmaproton.minimum=%f", fNSigmaProton[0])
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.nsigmaproton.maximum=%f", fNSigmaProton[1])
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.nhits.minimum=%i", fNHits[0])
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.nhits.maximum=%i", fNHits[1])
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.pt.minimum=%f", fPt[0])
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.pt.maximum=%f", fPt[1])
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.rapidity.minimum=%f", fRapidity[0])
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.rapidity.maximum=%f", fRapidity[1])
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.dca.minimum=%f", fDCA[0])
            ));
    settings_list->Add(new TObjString(
            TString::Format("MpdFemtoDummyTrackCut.dca.maximum=%f", fDCA[1])
            ));
