...
class MpdFemtoBaseModelWeightGenerator {
 ...
 public:
  ...
  virtual void setPairTypeFromPair(MpdFemtoPair *aPair) { mPairType = pairTypeFromPair( aPair ); }
  /// Return pair type
  ...
  virtual MpdFemtoBaseModelWeightGenerator* clone() const { return nullptr; }
