...
//     Inline functions
//
inline int MpdFemtoHelix::h() const {return mH;}

inline double MpdFemtoHelix::dipAngle() const {return mDipAngle;}

inline double MpdFemtoHelix::curvature() const {return mCurvature;}

inline double MpdFemtoHelix::phase() const {return mPhase;}
...
inline double MpdFemtoHelix::cz(double /* s */)  const { return mSinDipAngle; }
inline const TVector3& MpdFemtoHelix::origin() const { return mOrigin; }
inline TVector3 MpdFemtoHelix::at(double s) const { return TVector3(x(s), y(s), z(s)); }
inline TVector3 MpdFemtoHelix::cat(double s) const { return TVector3(cx(s), cy(s), cz(s)); }
inline double MpdFemtoHelix::pathLength(double X, double Y) const { return fudgePathLength(TVector3(X, Y, 0)); }
