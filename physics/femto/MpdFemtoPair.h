...
class MpdFemtoPair {
 ...
 public:
  ...
  double tpcEntranceSeparationV0pNegV0Pos() const
  ...
  void setTrack1(const MpdFemtoParticle* trkPtr) { mTrack1=(MpdFemtoParticle*)trkPtr; resetParCalculated(); }
  /// Set the second particle from a pair
  void setTrack2(const MpdFemtoParticle* trkPtr) { mTrack2=(MpdFemtoParticle*)trkPtr; resetParCalculated(); }
