...
class MpdFemtoTrack {
 ...
 public:
  ...
  float beta() const               { return (float)mTofBeta/20000.f; }
  /// Velocity of the track from TOF
  ...
  /// Helix of the primary track
  MpdFemtoPhysicalHelix Helix() const { return helix(); }
  ...
  void setHiddenInfo(MpdFemtoHiddenInfo* aHiddenInfo) { mHiddenInfo = aHiddenInfo; }
  /// Set hidden information
  void SetHiddenInfo(MpdFemtoHiddenInfo* aHiddenInfo) { setHiddenInfo(aHiddenInfo); }
  ...
  MpdFemtoHiddenInfo* getHiddenInfo() const { return mHiddenInfo; }
  /// Retrieve hidden info
  MpdFemtoHiddenInfo* hiddenInfo() const { return getHiddenInfo(); }
  /// Retrieve hidden info
  MpdFemtoHiddenInfo* GetHiddenInfo() const { return getHiddenInfo(); }
