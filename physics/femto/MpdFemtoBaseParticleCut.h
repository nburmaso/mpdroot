...
class MpdFemtoBaseParticleCut : public MpdFemtoCutMonitorHandler {
 ...
 public:
  ...
  /// Default destructor
  virtual ~MpdFemtoBaseParticleCut() { /* no-op */ }
  ...
  virtual MpdFemtoBaseParticleCut* clone() { return nullptr; }
...
inline MpdFemtoBaseParticleCut::MpdFemtoBaseParticleCut(const MpdFemtoBaseParticleCut& c) :
			MpdFemtoCutMonitorHandler(c), mMass(c.mMass), mBaseAnalysis(c.mBaseAnalysis) { /* empty */ }

//_________________
inline MpdFemtoBaseParticleCut& MpdFemtoBaseParticleCut::operator=(const MpdFemtoBaseParticleCut& c) {
  if( this != &c ) {
    MpdFemtoCutMonitorHandler::operator=(c); mBaseAnalysis = c.mBaseAnalysis; mMass = c.mMass;
  }
  return *this;
}
