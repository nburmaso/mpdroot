...
class MpdFemtoModelBPLCMS3DCorrFctnKt: public MpdFemtoBaseCorrFctn {
 ...
 public:
  ...
  TH3F* numeratorWeighted(int i)   { return (mNumeratorWeighted[i]) ? mNumeratorWeighted[i] : nullptr; }
  /// Return i-th weighted numerator
  TH3F* denominatorWeighted(int i) { return (mDenominatorWeighted[i]) ? mDenominatorWeighted[i] : nullptr; }
  ...
  virtual MpdFemtoModelBPLCMS3DCorrFctnKt* clone() const { return new MpdFemtoModelBPLCMS3DCorrFctnKt(*this); }
