...
class MpdFemtoTrackCutMonitor : public MpdFemtoBaseCutMonitor {
 ...
 public:
  ...
  TH1F* Pt() { return pt(); }
  /// nSigma(pion) vs pT
  TH2F* nSigmaPionVsPt() { return (mPtVsNsigmaPion) ? mPtVsNsigmaPion : nullptr; }
  /// nSigma(pion) vs pT
  TH2F* NSigmaPionVsPt() { return nSigmaPionVsPt(); }
  /// nSigma(pion) vs pT
  TH2F* PtVsNsigmaPion() { return mPtVsNsigmaPion; }
  /// nSigma(kaon) vs pT
  TH2F* nSigmaKaonVsPt() { return (mPtVsNsigmaKaon) ? mPtVsNsigmaKaon : nullptr; }
  /// nSigma(kaon) vs pT
  TH2F* NSigmaKaonVsPt() { return nSigmaKaonVsPt(); }
  /// nSigma(kaon) vs pT
  TH2F* PtVsNsigmaKaon() { return nSigmaKaonVsPt(); }
  /// nSigma(proton) vs pT
  TH2F* nSigmaProtonVsPt() { return (mPtVsNsigmaProton) ? mPtVsNsigmaProton : nullptr; }
  /// nSigma(proton) vs pT
  TH2F* NSigmaProtonVsPt() { return nSigmaProtonVsPt(); }
  /// nSigma(proton) vs pT
  TH2F* PtVsNsigmaProton() { return nSigmaProtonVsPt(); }
  /// dE/dx vs momentum
  ...
  /// Inveresed beta minus inversed beta for kaon hypothesis vs. momentum
  TH2F* InversedBetaDiffProtonVsP() { return inversedBetaDiffKaonVsP(); }
