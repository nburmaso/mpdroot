...
class MpdFemtoModelGausLCMSFreezeOutGenerator : public MpdFemtoBaseModelFreezeOutGenerator {
 ...
 public:
  ...
  /// Generate freeze-out coordinate (x,y,z,t)
  virtual void GenerateFreezeOut(MpdFemtoPair *aPair) { generateFreezeOut(aPair); }
  ...
  /// Clone generator
  virtual MpdFemtoBaseModelFreezeOutGenerator* clone() const { return generator(); }
 ...
 private:
  ...
  { MpdFemtoBaseModelFreezeOutGenerator* tModel = new MpdFemtoModelGausLCMSFreezeOutGenerator(*this); return tModel; }
