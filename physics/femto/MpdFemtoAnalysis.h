...
class MpdFemtoAnalysis : public MpdFemtoBaseAnalysis {
 ...
 public:
  ...
  { mCorrFctnCollection->push_back(cf); cf->setAnalysis( (MpdFemtoBaseAnalysis*)this ); }

  /// Set pair cut
  void setPairCut(MpdFemtoBasePairCut* x)
  { mPairCut = x; x->setAnalysis( (MpdFemtoBaseAnalysis*)this ); }
  /// Set event cut
  void setEventCut(MpdFemtoBaseEventCut* x)
  { mEventCut = x; x->setAnalysis( (MpdFemtoBaseAnalysis*)this ); }
  /// Set first particle cut
  void setFirstParticleCut(MpdFemtoBaseParticleCut* x)
  { mFirstParticleCut = x; x->setAnalysis( (MpdFemtoBaseAnalysis*)this ); }
  /// Set second particle cut
  void setSecondParticleCut(MpdFemtoBaseParticleCut* x)
  { mSecondParticleCut = x; x->setAnalysis( (MpdFemtoBaseAnalysis*)this ); }
  ...
  MpdFemtoPicoEvent* currentPicoEvent() { return mPicoEvent; }
  /// Return pointer to the current mixing buffer (particle collection)
  MpdFemtoPicoEventCollection* mixingBuffer() { return mMixingBuffer; }
...
//_________________
inline MpdFemtoBasePairCut* MpdFemtoAnalysis::pairCut() { return mPairCut; }

//_________________
inline MpdFemtoBaseEventCut* MpdFemtoAnalysis::eventCut() { return mEventCut; }

//_________________
inline MpdFemtoBaseParticleCut* MpdFemtoAnalysis::firstParticleCut() { return mFirstParticleCut; }

//_________________
inline MpdFemtoBaseParticleCut* MpdFemtoAnalysis::secondParticleCut() { return mSecondParticleCut; }

//_________________
inline MpdFemtoCorrFctnCollection* MpdFemtoAnalysis::corrFctnCollection() { return mCorrFctnCollection; }
