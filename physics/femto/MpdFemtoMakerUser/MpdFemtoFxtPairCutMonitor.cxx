...
#include "MpdFemtoFxtPairCutMonitor.h"
...
mPtVsEta(nullptr) {
  // Constructor
  string s("MpdFemtoFxtPairCutMonitor");
  string n(name);
...
//_________________
MpdFemtoFxtPairCutMonitor::MpdFemtoFxtPairCutMonitor(const MpdFemtoFxtPairCutMonitor& cutMoni) :
...
//_________________
MpdFemtoFxtPairCutMonitor MpdFemtoFxtPairCutMonitor::operator=(const MpdFemtoFxtPairCutMonitor& cutMoni) {
  // Assignment operator
  if (this != &cutMoni) {
    if (mKt) delete mKt;
    mKt = new TH1F(*cutMoni.mKt);
...
//_________________
MpdFemtoFxtPairCutMonitor::~MpdFemtoFxtPairCutMonitor() {
  if (mKt) {
    delete mKt;
    mKt = nullptr;
  }
...
//_________________
void MpdFemtoFxtPairCutMonitor::fill(const MpdFemtoPair* pair) {
...
//_________________
void MpdFemtoFxtPairCutMonitor::writeOutHistos() {
...
//_________________
TList* MpdFemtoFxtPairCutMonitor::getOutputList() {
