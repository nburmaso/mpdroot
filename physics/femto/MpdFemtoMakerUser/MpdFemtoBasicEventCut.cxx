...
bool MpdFemtoBasicEventCut::pass(const MpdFemtoEvent* ev) {
    ...
    if (mVerbose) {
        cout << Form("Impact parameter: %4.2f <= %4.2f <= %4.2f %s\n",
    ...
    if (mVerbose) {
        cout << Form("Vert Z         : %5.2f <= %5.2f <= %5.2f \t %s \n",
    ...
    if (mVerbose) {
        cout << Form("Vert R         : %3.2f <= %3.2f <= %3.2f \t %s \n",
    ...
    if (mVerbose) {
        cout << Form("Sphericity     : %3.2f <= %3.2f <= %3.2f \t %s \n",
    ...
    if (mVerbose) {
        cout << Form("psi            : %6.3f <= %6.3f <= %6.3f \t %s \n",
