...
class MpdFemtoModelWeightGeneratorLednicky : public MpdFemtoBaseModelWeightGenerator {
 ...
 public:
  ...
  /// Return kStar
  virtual double kStar() const      { return MpdFemtoBaseModelWeightGenerator::kStar(); }
  /// Return kStarOut
  virtual double kStarOut() const   { return MpdFemtoBaseModelWeightGenerator::kStarOut(); }
  /// Return kStarSide
  virtual double kStarSide() const  { return MpdFemtoBaseModelWeightGenerator::kStarSide(); }
  /// Return kStarLong
  virtual double kStarLong() const  { return MpdFemtoBaseModelWeightGenerator::kStarLong(); }
  /// Return rStar
  virtual double rStar() const      { return MpdFemtoBaseModelWeightGenerator::rStar(); }
  /// Return rStarOut
  virtual double rStarOut() const   { return MpdFemtoBaseModelWeightGenerator::rStarOut(); }
  /// Return rStarSide
  virtual double rStarSide() const  { return MpdFemtoBaseModelWeightGenerator::rStarSide(); }
  /// Return rStarLong
  virtual double rStarLong() const  { return MpdFemtoBaseModelWeightGenerator::rStarLong(); }

  /// Clone generator
  virtual MpdFemtoBaseModelWeightGenerator* clone() const
  { MpdFemtoBaseModelWeightGenerator* tmp = new MpdFemtoModelWeightGeneratorLednicky(*this); return tmp; }
