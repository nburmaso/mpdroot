...
//------------------------------------------------------------------------------------------------------------------------
class MpdSts : public FairDetector
{
...
public:
  	...
  	MpdSts(const char* name, Bool_t active);
...
private:
	...
	// Adds a MpdStsPoint to the HitCollection
  	MpdStsPoint* AddHit(Int_t trackID, Int_t detID, TVector3 posIn, 
			    TVector3 momIn, TVector3 posOut, Double_t time, Double_t length, Double_t eLoss); 
...
//------------------------------------------------------------------------------------------------------------------------
inline void MpdSts::ResetParameters() 
{
