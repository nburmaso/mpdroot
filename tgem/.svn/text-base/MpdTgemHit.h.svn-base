...
class MpdTgemHit : public FairHit
{
 ...
 public:
  ...
  MpdTgemHit(Int_t detectorID, TVector3 pos, TVector3 dpos, Int_t refIndex, Int_t flag);

  /** Constructor with hit parameters (2) [not the flag]**/
  MpdTgemHit(Int_t detectorID, TVector3 pos, TVector3 dpos, Int_t refIndex);
