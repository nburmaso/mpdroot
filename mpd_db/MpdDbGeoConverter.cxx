// -------------------------------------------------------------------------
// -----                      MpdDbGeoConverter cxx file               -----
// -----                  Created 04/08/15  by K. Gertsenberger        -----
// -------------------------------------------------------------------------
#include "MpdDbGeoConverter.h"
...
MpdDbGeoConverter::MpdDbGeoConverter()
{
}
// -------------------------------------------------------------------------

// hierarchical writing geometry data to database
int MpdDbGeoConverter::RecursiveNodeChanging(TSQLServer* uni_db, TGeoNode* node, int parent_node_id)
{
...
int MpdDbGeoConverter::WriteRootGeoToDB(TString geo_file_path)
{
    if (geo_file_path == "")
    {
    ...
    MpdDbConnection* connectionUniDb = MpdDbConnection::Open(UNIFIED_DB);
