...
class CpcDigi : public TObject {
public:
  CpcDigi();
  CpcDigi(Int_t pfDetectorID, Int_t pfModuleID, Int_t pfChannelID,
          Double_t pfELoss = 0, Bool_t pIsPsd = kFALSE);
  CpcDigi(MpdCpcPoint *p, Bool_t pIsPsd = kFALSE);
  ...
  UInt_t AddCpcPoint(MpdCpcPoint *p);
