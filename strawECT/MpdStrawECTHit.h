#ifndef MPDStrawECTHIT_H
#define MPDStrawECTHIT_H

#include "FairHit.h"

#include "TArrayI.h"

class MpdStrawECTHit : public FairHit
{
 ...
 public:
  ...
  MpdStrawECTHit(Int_t detectorID, TVector3 pos, TVector3 dpos, Int_t refIndex, Int_t flag);

  /** Constructor with hit parameters (2) [not the flag]**/
  MpdStrawECTHit(Int_t detectorID, TVector3 pos, TVector3 dpos, Int_t refIndex);

  /** Destructor **/
  virtual ~MpdStrawECTHit();
