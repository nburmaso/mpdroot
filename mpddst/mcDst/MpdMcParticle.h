...
public:
    ...
    Int_t parentDecay() const {
        return (Int_t) fParentDecay;
    }
    /// Return parent decay index
    ...
    void setChild(Int_t child[2]) {
        setFirstChild(child[0]);
        setLastChild(child[1]);
    }
    /// Set 2 childer indeces
