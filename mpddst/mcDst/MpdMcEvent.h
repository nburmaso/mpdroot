...
public:
    ...
    Double_t stepT() const {
        return (Double_t) fStepT;
    }
    /// Return time of the step (stamp)
    ...
    void setEventNr(const Int_t& eventNr) {
    ...
    void setImpact(const Double_t& impact) {
        setB(impact);
    }
    /// Set reaction plane angle

    void setPhi(const Double_t& phi) {
        fPhi = (Float_t) phi;
    }
    /// Set reaction plane angle
    ...
    void setStepT(const Double_t& stepT) {
        fStepT = (Float_t) stepT;
    }
    /// Set time of the current step

    void setStepTime(const Double_t& time) {
        setStepT(time);
    }
    /// Set comment
