...
#include <bitset>
MpdPairKalmanPadsCuts::MpdPairKalmanPadsCuts():MpdModularTpcPairCut(9) {
...
Bool_t MpdPairKalmanPadsCuts::Pass(NicaTwoTrack* pair) {
	...
	track1->CalculatePads(kFALSE);
	track2->CalculatePads(kFALSE);
...
MpdPairKalmanPadsCuts::MpdPairKalmanPadsCuts(
		const MpdPairKalmanPadsCuts& other) :MpdModularTpcPairCut(other),
...
NicaPackage* MpdPairKalmanPadsCuts::Report() const {
	NicaPackage *report=  MpdModularTpcPairCut::Report();
