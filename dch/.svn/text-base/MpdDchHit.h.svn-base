//------------------------------------------------------------------------------------------------------------------------
#ifndef __MPD_DCH_HIT_H
#define __MPD_DCH_HIT_H 1

#include "FairHit.h"

#include "TArrayI.h"
//------------------------------------------------------------------------------------------------------------------------
class MpdDchHit : public FairHit
{

public:

  MpdDchHit();
  MpdDchHit(Int_t detectorID, TVector3 pos, TVector3 dpos, Int_t refIndex, Int_t flag);
  MpdDchHit(Int_t detectorID, TVector3 pos, TVector3 dpos, Int_t refIndex);
  ...
  Int_t GetLayer() const { return  fDetectorID; } // get number of measurements per point
